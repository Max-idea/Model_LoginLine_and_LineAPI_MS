...
class LineLogin
{
    private const DB_HOST = 'localhost:8888';
    private const DB_USERNAME = 'root';
    private const DB_PASSWORD = '6UYVrqJpqoRd';
    private const DB_NAME = 'bitnami_wordpress';
    #### change your id
    private const CLIENT_ID = '1661430311';
    private const CLIENT_SECRET = 'd6c16b1bdfefe417c8e1082ca036318a';
    private const REDIRECT_URL = 'http://localhost/Line_login/callback.php';
    ...
    private function insertUserData($userData)
    {
        ...
        $picture = $conn->real_escape_string($userData['picture']);
        $email = $conn->real_escape_string($userData['email']);
        $sub = $conn->real_escape_string($userData['sub']);

        // Prepare the SQL statement
        $sql = "INSERT INTO Line_Users (name, picture, email, sub) VALUES ('$name', '$picture', '$email', '$sub')";
